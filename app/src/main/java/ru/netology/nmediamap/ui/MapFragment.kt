...
import ru.netology.nmediamap.databinding.MapFragmentBinding
import ru.netology.nmediamap.databinding.PlaceBinding
...
class MapFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mapView = binding.map.apply {
            ...
            val traffic = MapKitFactory.getInstance().createTrafficLayer(mapWindow)
